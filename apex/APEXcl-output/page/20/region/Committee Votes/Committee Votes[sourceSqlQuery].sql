...
, decode(:P20_COMMITTEE_VOTE_TOTAL,0, 0, round(cnt * 100 / :P20_COMMITTEE_VOTE_TOTAL))  percent_complete
, apex_util.html_pct_graph_mask(decode(:P20_COMMITTEE_VOTE_TOTAL,0, 0, round(cnt * 100 / :P20_COMMITTEE_VOTE_TOTAL,2))) bar
from (
